...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.project": "项目",
    "settings.chatDescription": "调整消息布局与对话行为。",
    "settings.chatContentFontSizeDescription": "设置消息和输入框的文字大小。",
    "settings.quoteSelectionDescription": "引用对话中选中的文字，或针对其提问。",
    "settings.general": "常规",
    "settings.generalDescription": "自定义工作区外观与对话偏好。",
    "settings.appearance": "外观",
    "settings.appearanceDescription": "选择 Pi Desktop 的显示风格。",
    ...
    "modelPicker.noFavorites": "点击模型旁的星标以收藏。",
    ...
    "workspace.newThread": "新对话",
    "workspace.threadTools": "对话工具",
    "workspace.closeSearch": "关闭搜索",
    "workspace.search": "搜索",
    "workspace.project": "项目",
    "workspace.threads": "对话",
    "workspace.buildIn": "想在 {project} 中构建什么？",
    "workspace.startHint": "提出修改、探索想法，或继续之前的工作。",
    ...
    "chatMinimap.navigation": "消息导航",
    "chatMinimap.jumpToMessage": "跳转到消息 {number}：{preview}",
