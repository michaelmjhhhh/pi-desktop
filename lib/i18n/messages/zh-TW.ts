...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.project": "專案",
    "settings.chatDescription": "調整訊息版面配置與對話行為。",
    "settings.chatContentFontSizeDescription": "設定訊息和輸入框的文字大小。",
    "settings.quoteSelectionDescription": "引用對話中選取的文字，或針對其提問。",
    "settings.general": "一般",
    "settings.generalDescription": "自訂工作區外觀與對話偏好。",
    "settings.appearance": "外觀",
    "settings.appearanceDescription": "選擇 Pi Desktop 的顯示風格。",
    ...
    "agents.close": "關閉",
    "agents.builtInTitle": "啟用 Pi Desktop 內建子代理",
    "agents.builtInDescription": "提供 Pi Desktop 整合的 Agent 工具，並停用發生衝突的 pi-subagents 擴充功能。",
    ...
    "modelPicker.title": "選擇模型",
    "modelPicker.providers": "模型供應商",
    "modelPicker.all": "全部模型",
    "modelPicker.favorites": "收藏",
    "modelPicker.noFavorites": "點擊模型旁的星號以收藏。",
    "modelPicker.selected": "目前模型",
    "modelPicker.pin": "收藏 {model}",
    "modelPicker.unpin": "取消收藏 {model}",
    "workspace.settled": "已結束",
    "workspace.allProjects": "所有專案",
    "workspace.addProject": "新增專案",
    "workspace.projectSettings": "{project} 的設定",
    "workspace.newThread": "新對話",
    "workspace.threadTools": "對話工具",
    "workspace.closeSearch": "關閉搜尋",
    "workspace.search": "搜尋",
    "workspace.project": "專案",
    "workspace.threads": "對話",
    "workspace.buildIn": "想在 {project} 中建構什麼？",
    "workspace.startHint": "提出修改、探索想法，或繼續之前的工作。",
    ...
    "chatMinimap.navigation": "訊息導覽",
    "chatMinimap.jumpToMessage": "跳至訊息 {number}：{preview}",
