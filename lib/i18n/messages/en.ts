...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chatDescription": "Adjust message layout and conversation behavior.",
    "settings.chatContentFontSizeDescription": "Set the reading size for messages and the composer.",
    "settings.quoteSelectionDescription": "Quote or ask about text you select in a conversation.",
    "settings.general": "General",
    "settings.generalDescription": "Customize your workspace and conversation preferences.",
    "settings.appearance": "Appearance",
    "settings.appearanceDescription": "Choose how Pi Desktop looks.",
    ...
    "modelPicker.providers": "Model providers",
    "modelPicker.all": "All models",
    "modelPicker.favorites": "Favorites",
    "modelPicker.noFavorites": "Star a model to keep it here.",
    ...
    "workspace.newThread": "New thread",
    "workspace.threadTools": "Thread tools",
    "workspace.closeSearch": "Close search",
    "workspace.search": "Search",
    "workspace.project": "Project",
    "workspace.threads": "Threads",
    "workspace.buildIn": "What should we build in {project}?",
    "workspace.startHint": "Ask for changes, explore an idea, or pick up where you left off.",
    ...
    "sidebar.filterProjects": "Search projects…",
    ...
    "chatMinimap.navigation": "Message navigation",
    "chatMinimap.jumpToMessage": "Jump to message {number}: {preview}",
