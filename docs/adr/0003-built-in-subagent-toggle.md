...
Pi Desktop's integrated sub-agent implementation is an inline, hidden extension.
...
When the integrated extension is disabled, Pi Desktop does not suppress the legacy
